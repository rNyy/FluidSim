...
public:
	...
	void advect2DMac(matrix<double>& nxt, matrix<double> &fwd,matrix<double> &bwd,matrix<double> &u); //passing u and v compenents...
	void advect2DSelf_fwd(matrix<double>& q, double,matrix<double> &u,matrix<double> &v,int ); //passing u and v compenents...
	///////////////////////////////////////
	...
	void clampMaccormack(matrix<double>& nxt,matrix<double>& bwd,matrix<double>& curr);
